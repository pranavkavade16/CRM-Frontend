  ...
  return (
    <div className="dashboard-wrapper">
      <div className="d-flex justify-content-between align-items-center">
        <div>
          <div className="row" style={{ width: "680px" }}>
            <div className="col">
          ...
          <p className="text-muted mt-3">
            <div className="d-flex align-items-start">
              <p>
                ...
                <span className="ms-1">
                  {new Date(activeLead?.createdAt).toLocaleDateString("en-IN", {
                    day: "2-digit",
                    month: "long",
                    year: "numeric",
                  })}
        ...
        <div>
          {toggleEdit ? (
            ...
            <div className="row g-0" style={{ width: "205px" }}>
              <div className="col">
                <button
                  className="btn btn-dark rounded-3 px-3"
                  onClick={() => setToggleEdit(!toggleEdit)}
      ...
      <div class="tab-content mt-4 m-2" id="nav-tabContent">
          ...
          {toggleEdit ? (
            <div>
              <div className="row">
                ...
                <div className="col-4">
                  ...
                  <div class="card mt-4" style={{ width: "380px" }}>
                    <div class="card-body">
            ...
            <div className="row">
              ...
              <div className="col-4">
                <div class="card" style={{ width: "380px" }}>
                  <div class="card-body">
                    <h5 className="fw-bold mt-2 mb-4">Assigned Sales Agent</h5>
                    <div className="row">
                      <div className="col-2">
                        <img
                ...
                <div class="card mt-4" style={{ width: "380px" }}>
                  <div class="card-body">
                    ...
                    <div className="d-flex align-items-start mb-4">
                      ...
                      <div>
                        <div className="fw-semibold h6 mb-1">Last Updated</div>
                        <div className="text-secondary">{updatedDate}</div>
                      </div>
                    </div>
        ...
        >
          <div>
            <div class="card border w-75 mx-auto rounded-4 p-2 bg-white">
          ...
          <div>
            {commentData?.map((comment) => (
              <div className="mt-3">
                <div class="border w-75 mx-auto rounded-4 p-4 bg-white">
